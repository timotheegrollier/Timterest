...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @Assert\NotBlank(message="Veuillez rentrez une adresse Email")
     * @Assert\Email(message="Veuillez rentrez une adresse Email valide")
     * 
     ...
     * @Assert\NotBlank(message="Veuillez rentrez un prénom")
     */
    private $firstName;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank(message="Veuillez rentrez un nom")
     * 
     */
    private $lastName;
